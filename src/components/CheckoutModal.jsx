...
import { X, ShoppingCart, CheckCircle, AlertCircle, MapPin, Mail, Phone, User } from "lucide-react";
    ...
    <>
      ...
      {message && (
        <div className="fixed inset-0 z-60 flex items-center justify-center pointer-events-none">
          <div className={`p-6 rounded-xl shadow-2xl max-w-md w-[80%] flex items-center space-x-3 pointer-events-auto transform transition-all duration-300 scale-100 animate-scaleIn ${
